# Торговые караваны, плавильня и верстак
...
В вашей мастерской находится небольшая плавильная печь и верстак. Используя их, вы и будете в итоге изготавливать необходимые запчасти для алхимиков. 

В плавильне вы будете получать из ваших ресурсов необходимые для изготовления запчастей материалы. В таблице показано соотношение ресурсов к материалам при их выплавке. 

![](images/verstak_ru.2x.png)

Далее из полученных материалов на верстаке будут изготавливаться запчасти.
  
Ниже в таблицах показано время изготовления в зависимости от вида повозки и запчасти, а также количество материалов, необходимое для каждой запчасти:

![](images/verstak22_ru.2x.png)

![](images/verstak3_ru.2x.png)


Как видно из таблицам, найм охраны и торговца приносит примерно +57% к итоговому количеству получаемых ресурсов, если сравнивать караван без них. Игроки уже собравшие ассетные повозки, а тем более имеющие у себя NFT повозки-мастерские, будут иметь существенное преимущество на всех этапах изготовления запчастей. Что должно повысить их заработок во free2play части нашей игры. Самой эффективной связкой в режиме free2play становится владение редкого гоблина-ремонтника и NFT повозки-мастерской.
